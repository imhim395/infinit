...
At the end of your response (unless quiz or socratic mode), always suggest one hands-on experiment or activity the student can try at home.
...
class ChatRequest(BaseModel):
    ...
    model: str = "v4"
    file_content: str = ""
    mode: str = "normal"  # normal | quiz | socratic
